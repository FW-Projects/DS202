...
void wk_adc1_init(void)
{
  ...
  gpio_init_struct.gpio_pins = AD_AIRGUN_PIN;
  gpio_init(AD_AIRGUN_GPIO_PORT, &gpio_init_struct);

  /* configure the IN2 pin */
  gpio_init_struct.gpio_mode = GPIO_MODE_ANALOG;
  gpio_init_struct.gpio_pins = AD_HOTGUN_PIN;
  gpio_init(AD_HOTGUN_GPIO_PORT, &gpio_init_struct);

  /* configure the IN3 pin */
  gpio_init_struct.gpio_mode = GPIO_MODE_ANALOG;
  gpio_init_struct.gpio_pins = OVER_LOAD_PIN;
  gpio_init(OVER_LOAD_GPIO_PORT, &gpio_init_struct);
