...
#define AIR_TEMP_EC11_A_GPIO_PORT    GPIOC
#define AIR_TEMP_EC11_A_GPIO_PIN     GPIO_PINS_9

#define AIR_TEMP_EC11_B_GPIO_PORT    GPIOC
#define AIR_TEMP_EC11_B_GPIO_PIN     GPIO_PINS_8

#define AIR_TEMP_EC11_KEY_GPIO_PORT  GPIOA
#define AIR_TEMP_EC11_KEY_GPIO_PIN   GPIO_PINS_8

#define SOL_TEMP_EC11_A_GPIO_PORT    GPIOB
#define SOL_TEMP_EC11_A_GPIO_PIN     GPIO_PINS_13

#define SOL_TEMP_EC11_B_GPIO_PORT    GPIOB
#define SOL_TEMP_EC11_B_GPIO_PIN     GPIO_PINS_12

#define SOL_TEMP_EC11_KEY_GPIO_PORT  GPIOC
#define SOL_TEMP_EC11_KEY_GPIO_PIN   GPIO_PINS_7

#define AIR_EC11_A_GPIO_PORT    GPIOC
#define AIR_EC11_A_GPIO_PIN     GPIO_PINS_6

#define AIR_EC11_B_GPIO_PORT    GPIOB
#define AIR_EC11_B_GPIO_PIN     GPIO_PINS_15

#define AIR_EC11_KEY_GPIO_PORT  GPIOC
#define AIR_EC11_KEY_GPIO_PIN   GPIO_PINS_14
...
extern EC11_Encoder air_temp_ec11;
extern EC11_Encoder sol_temp_ec11;
