...
//air_temp_ec11
EC11_Encoder air_temp_ec11 =
{
    .config.gpio_a                         = AIR_TEMP_EC11_A_GPIO_PORT,
    .config.gpio_b                         = AIR_TEMP_EC11_B_GPIO_PORT,
    .config.gpio_key                       = AIR_TEMP_EC11_KEY_GPIO_PORT,
    .config.pin_a                          = AIR_TEMP_EC11_A_GPIO_PIN,
    .config.pin_b                          = AIR_TEMP_EC11_B_GPIO_PIN,
    .config.pin_key                        = AIR_TEMP_EC11_KEY_GPIO_PIN,
    .config.type                           = EC11_TYPE_SINGLE_PULSE,
    .config.scan_period_ms                 = 4,

    // 时间参数(基于扫描周期计算)
    .config.debounce_count = 5,        // 20ms / 5ms = 4次
    .config.long_press_count = 250,    // 600ms / 5ms = 120次
...
//sol_temp_ec11
EC11_Encoder sol_temp_ec11 =
{
    .config.gpio_a                         = SOL_TEMP_EC11_A_GPIO_PORT,
    .config.gpio_b                         = SOL_TEMP_EC11_B_GPIO_PORT,
    .config.gpio_key                       = SOL_TEMP_EC11_KEY_GPIO_PORT,
    .config.pin_a                          = SOL_TEMP_EC11_A_GPIO_PIN,
    .config.pin_b                          = SOL_TEMP_EC11_B_GPIO_PIN,
    .config.pin_key                        = SOL_TEMP_EC11_KEY_GPIO_PIN,
    .config.type                           = EC11_TYPE_SINGLE_PULSE,
    .config.scan_period_ms                 = 4,
